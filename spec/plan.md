...
- faire des transformations sur ces données afin de les rendre exploitable
...
- pouvoir superposer une densité d'une loi de proba connu (paramètre à régler) à un graphe obtenu à partir des données.

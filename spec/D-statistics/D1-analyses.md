...
| **Brush / zoom** ([C3](../C-visualizations/C3-interactions.md)) | Recalcul des analyses sur la **plage sélectionnée** |
...
[D2](./D2-programmes-statistiques.md) · [B3](../B-clean-data/B3-clean-vers-unified.md)
